        ...
        <Box width={1} borderRadius={5} height={{ xs: 'calc(100vh - 457px)', md: 'calc(100vh - 260px)' }} sx={{
            ...
            <Stack mt={20} alignItems={'center'}>
                <Stack sx={{ borderLeft: 8, borderColor: 'secondary.main', pl: 2 }}>
                    <Typography fontSize={40} fontWeight={900} letterSpacing={4} color="secondary.main">Mainnet Launching</Typography>
                    <Typography fontSize={24} fontWeight={500} letterSpacing={2}>June 29 at 09:00 UTC</Typography>
                </Stack>
