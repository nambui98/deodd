...
export const TableMyTickets = ({ data, getStatus, resultLottery }: Props) => {
                                ...
                                >
                                    ...
                                    >
                                        <Stack direction={'row'} alignItems={'center'} gap={2}>
                                            ...
                                            {
                                                ticket.draw_id !== currentLottery?.draw_id &&
                                                <Box sx={{ cursor: 'pointer' }} onClick={() => setOpenModalProvablyFair({ open: true, ticketSelected: ticket.series, resultLottery })}>
...
export const TableResultRoll = ({ data, resultLottery }: { data: WinnerType[], resultLottery: JackpotType }) => {
                                ...
                                >
                                    <Stack direction={'row'} gap={2} alignItems={'center'}>
                                        ...
                                        <Box sx={{ cursor: 'pointer' }} onClick={() => {
                                            setOpenModalProvablyFair({ open: true, ticketSelected: row.series, resultLottery: resultLottery })
