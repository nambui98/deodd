...
function RightSidebar({ open, mobileOpen, handleDrawerToggle, window }: Props) {
    ...
    const DrawerContent = () => (
        <Box position={'relative'}>
            ...
            <Box bgcolor={'primary.200'} zIndex={1} position={'fixed'} bottom={{ md: 0, xs: 65 }} right={0} width={DRAWER_WIDTH}>
            ...
            {/* </Box> */}
            <Box zIndex={1} position={'fixed'} bottom={{ md: 77, xs: 142 }} right={8} textAlign={'right'}>
                <Button
                    // size="small"
                    variant="outlined"
                    onClick={() => {
