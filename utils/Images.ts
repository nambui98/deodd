...
export const AsiaTokenFundImage = "/assets/images/asiatokenfund.png";
export const TechSulionImage = "/assets/images/textsulion.png";
export const ScoopnixImage = "/assets/images/scoopnix.png";
export const ApImage = "/assets/images/ap.png";
export const BenzingaImage = "/assets/images/benzinga.png";
...
export const BannerLotteryMobileImage = "/assets/images/lotterybannermobile.png";
